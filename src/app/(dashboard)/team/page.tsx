    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Manage member permissions and roles for {activeCompany?.name || 'your company'}
        </p>
      </div>
      ...
      <div className="bg-card border border-border/60 rounded-xl p-8 flex flex-col items-center justify-center text-center py-20 bg-muted/10">
        ...
        <h3 className="text-lg font-bold text-foreground">Workspace Roles</h3>
        <p className="text-sm text-muted-foreground max-w-sm mt-1">
          Invite teammates as Owner, Admin, Marketing Manager, or Viewer. Access is isolated per company.
        </p>
      </div>
    </div>
  )
