    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Historical social performance charts for {activeCompany?.name || 'your company'}
        </p>
      </div>
      ...
      <div className="bg-card border border-border/60 rounded-xl p-8 flex flex-col items-center justify-center text-center py-20 bg-muted/10">
        <BarChart3 className="w-12 h-12 text-muted-foreground/60 mb-3" />
        <h3 className="text-lg font-bold text-foreground">No Analytics Data Found</h3>
        <p className="text-sm text-muted-foreground max-w-sm mt-1">
          Connect your platform accounts in the Connections tab to start accumulating historical metrics.
        </p>
      </div>
    </div>
  )
